...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#2B1E1A] text-white">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/services/corporate" className="text-white/70 hover:text-[#C9653B] transition-colors text-sm">Corporate</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              ...
              <li>
                <a href="tel:+31653301243" className="hover:text-[#C9653B] transition-colors flex items-center gap-2">
                  <span>📞</span>
                  +31 6 5330 1243
                </a>
              </li>
              <li>
                <a href="https://wa.me/31653301243" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9653B] transition-colors flex items-center gap-2">
