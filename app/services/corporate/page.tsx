...
export default function CorporatePage() {
  return (
    <ServicePageTemplate
      ...
      introText="Elevate your corporate events with something memorable. Whether it's a team lunch, client meeting, conference, or company celebration, our authentic Tanzanian cuisine brings people together and creates talking points. Professional service, reliable timing, and exceptional food — every time."
