...
// Exclude specific images from the carousel by adding their paths here
const excludedFoodImages: string[] = [
  "/food-1.jpg",
  "/food-2.jpg",
];
...
const foodImages = [
  "/delivery.jpg",
  ...galleryItems
    .filter(item => item.category === "food" && !excludedFoodImages.includes(item.src))
    .map(item => item.src)
];
