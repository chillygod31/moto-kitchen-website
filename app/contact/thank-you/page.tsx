  ...
  return (
    <section className="pt-32 pb-20 bg-[#FAF6EF] min-h-screen flex items-center">
      <div className="max-w-2xl mx-auto px-6 text-center">
        ...
        <div className="mt-12 p-6 bg-[#F1E7DA] rounded-lg border border-[#E6D9C8]">
          <p className="font-semibold text-[#1F1F1F] mb-2">Need a faster response?</p>
          <p className="text-[#4B4B4B] text-sm mb-4">
            For urgent inquiries, reach out via WhatsApp:
          </p>
          <a 
            href="https://wa.me/31600000000" 
            className="text-[#C9653B] font-semibold hover:underline inline-flex items-center gap-2"
          >
